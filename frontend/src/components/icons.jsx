...
// --- Iconos temáticos por categoría (psicología clínica) ---
...
export function Stethoscope(props) {
  return (
    <svg {...base} {...props}>
      <path d="M4.5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 6 6 6 6 0 0 0 6-6V5a2 2 0 0 0-2-2h-.5" />
...
export function Sparkles(props) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M19 14l.6 1.8 1.9.6-1.9.6-.6 1.8-.6-1.8-1.9-.6 1.9-.6z" />
    </svg>
  );
}
...
export function Crown(props) {
  return (
    <svg {...base} {...props}>
      <path d="M11.56 3.27a.5.5 0 0 1 .88 0l2.95 5.6a1 1 0 0 0 1.52.3l4.28-3.67a.5.5 0 0 1 .8.52l-2.84 10.25a1 1 0 0 1-.95.73H5.81a1 1 0 0 1-.96-.73L2.02 6.02a.5.5 0 0 1 .8-.52l4.28 3.67a1 1 0 0 0 1.51-.3z" />
      <path d="M5 21h14" />
    </svg>
  );
}
...
// Mismo trazo que ya usaba el "citar" local de ReaderPanel.jsx (ahí se deja
// tal cual, sin tocar un componente que ya funciona) — aquí queda disponible
// para el resto de la app sin duplicar el path.
